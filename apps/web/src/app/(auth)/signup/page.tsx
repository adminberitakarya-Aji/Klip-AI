...
const perks = [
  {
    emoji: "🎬",
    title: "50 kredit gratis",
    desc: "Langsung bisa generate video setelah daftar",
  },
  {
    emoji: "⚡",
    title: "Instan & mudah",
    desc: "Tidak perlu kartu kredit untuk memulai",
  },
  {
    emoji: "🎨",
    title: "100+ template",
    desc: "Template profesional siap pakai untuk semua niche",
  },
  {
    emoji: "🔒",
    title: "Data aman",
    desc: "Enkripsi end-to-end & privasi terjamin",
  },
];
  ...
  return (
    <div className="min-h-screen flex bg-[oklch(0.04_0_0)]">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col justify-between p-12 overflow-hidden">
        ...
        {/* Orbs */}
        <div
          className="absolute top-[-5%] right-[-10%] w-[500px] h-[500px] rounded-full opacity-25"
          style={{
            background:
              "radial-gradient(circle, oklch(0.55 0.2 205 / 0.6) 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        <div
        ...
        <div className="relative z-10 space-y-10">
          <div>
            <div
              ...
              style={{
                background: "oklch(0.82 0.15 205 / 0.12)",
            ...
            >
              ...
              kreatif Anda
              <br />
              <span style={{ color: "oklch(0.82 0.15 205)" }}>hari ini</span>
            </h2>
            <p
              className="mt-4 text-base leading-relaxed"
              style={{ color: "oklch(1 0 0 / 0.5)" }}
            >
              Ribuan kreator Indonesia sudah menggunakan Klip-AI untuk
              menghasilkan konten video berkualitas tinggi.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              {["210", "150", "55", "280"].map((h, i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full border-2"
                  style={{
                    background: `oklch(0.5 0.15 ${h})`,
                    borderColor: "oklch(0.06 0 0)",
                  }}
                />
              ))}
            </div>
            <p className="text-sm" style={{ color: "oklch(1 0 0 / 0.5)" }}>
              <span className="text-white font-semibold">10.000+</span> kreator
              sudah bergabung
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-[400px] animate-fade-up">
          ...
          <div className="mb-8">
            ...
            >
              Dapatkan 50 kredit gratis untuk mulai berkreasi
            </p>
          </div>
