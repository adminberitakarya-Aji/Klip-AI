...
export function Footer() {
  return (
    <footer className="relative border-t border-neutral-900 bg-neutral-950/50">
      {/* Background glow */}
      <div
        className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_center,rgba(139,92,246,0.08),transparent_70%)]"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          >
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-6 max-w-xs">
              The unified platform for cinematic AI video generation. Multiple
              models, one workflow, unlimited creativity.
            </p>
          ...
          {Object.entries(navigation).map(([category, links], catIndex) => (
            ...
            >
              <h4 className="font-semibold text-white mb-4 tracking-tight">
          ...
          <div className="flex flex-wrap items-center justify-between gap-6 mb-10">
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <Button
                  size="sm"
                  className="gap-2 px-4 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-600 shadow-lg shadow-purple-600/25"
                >
                  Subscribe
